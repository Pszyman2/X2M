...
% x2mGui MATLAB code for x2mGui.fig
%      x2mGui, by itself, creates a new x2mGui or raises the existing
%      singleton*.
%
%      H = x2mGui returns the handle to a new x2mGui or the handle to
%      the existing singleton*.
%
%      x2mGui('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in x2mGui.M with the given input arguments.
%
%      x2mGui('Property','Value',...) creates a new x2mGui or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the x2mGui before x2mGui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to x2mGui_OpeningFcn via varargin.
%
%      *See x2mGui Options on GUIDE's Tools menu.  Choose "x2mGui allows only one
%      instance to run (singleton)".
%
% See also: GUIDE, GUIDATA, GUIHANDLES

% Edit the above text to modify the response to help x2mGui

% Last Modified by GUIDE v2.5 18-Aug-2018 08:26:36
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @x2mGui_OpeningFcn, ...
                   'gui_OutputFcn',  @x2mGui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function x2mGui_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = x2mGui_OutputFcn(hObject, eventdata, handles) 
